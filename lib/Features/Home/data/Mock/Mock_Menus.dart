  ...
  static final Map<String, List<MenuItemModel>> itemsByCategory = {
    'Burger': [
      MenuItemModel(
        ...
        price: 110,
        image: 'assets/images/menu/classicBurger.jpg',
      ),
      MenuItemModel(
        id: 'b_2',
        name: 'Double Burger',
        ...
        price: 150,
        image: 'assets/images/menu/DoubleBurger.jpg',
      ),
      MenuItemModel(
        id: 'b_3',
        name: 'BBQ Burger',
        ...
        price: 145,
        image: 'assets/images/menu/BBQBurger2.jpg',
      ),
      MenuItemModel(
        id: 'b_4',
        ...
        price: 140,
        image: 'assets/images/menu/MashroumBurger.jpg',
      ),
      MenuItemModel(
        id: 'b_5',
        name: 'Chicken Burger',
        ...
        price: 120,
        image: 'assets/images/menu/chickenBurger.jpg',
      ),
      MenuItemModel(
        id: 'b_6',
        name: 'Spicy Burger',
        ...
        price: 135,
        image: 'assets/images/menu/SpicyBurger.jpg',
      ),
    ],
    ...
    'Pizza': [
      MenuItemModel(
        ...
        price: 130,
        image: 'assets/images/menu/margherita.jpg',
      ),
      MenuItemModel(
        id: 'p_2',
        name: 'Pepperoni',
        ...
        price: 165,
        image: 'assets/images/menu/pepperoni.jpg',
      ),
      MenuItemModel(
        id: 'p_3',
        name: 'BBQ Chicken',
        ...
        price: 175,
        image: 'assets/images/menu/BBQChicken.jpg',
      ),
      MenuItemModel(
        id: 'p_4',
        name: 'Vegetarian',
        ...
        price: 140,
        image: 'assets/images/menu/Vigitrian.jpg',
      ),
      MenuItemModel(
        id: 'p_5',
        name: 'Cheese Lovers',
        ...
        price: 155,
        image: 'assets/images/menu/cheese.jpg',
      ),
      MenuItemModel(
        id: 'p_6',
        name: 'Seafood Pizza',
        ...
        price: 190,
        image: 'assets/images/menu/seafood.jpg',
      ),
    ],
    ...
    'Sandwich': [
      ...
      MenuItemModel(
        ...
        price: 100,
        image: 'assets/images/menu/beef.jpg',
      ),
      MenuItemModel(
        id: 's_3',
        name: 'Hot Dog',
      ...
      MenuItemModel(
        ...
        price: 85,
        image: 'assets/images/menu/shawarma.jpg',
      ),
      MenuItemModel(
        id: 's_5',
        name: 'Tuna Sandwich',
        ...
        price: 95,
        image: 'assets/images/menu/tuna.jpg',
      ),
      MenuItemModel(
        id: 's_6',
        name: 'Spicy Sandwich',
        ...
        price: 100,
        image: 'assets/images/menu/spicy.jpg',
      ),
    ],
